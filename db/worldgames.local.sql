...
-- -----------------------------------------------------
-- Table `worldgames`.`Admistrador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `worldgames`.`Admistrador` (
...
-- -----------------------------------------------------
-- Table `worldgames`.`Game_has_Plataform`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `worldgames`.`Game_has_Plataform` (
  `Game_ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `worldgames`.`Game_has_Offer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `worldgames`.`Game_has_Offer` (
  `Game_ID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `worldgames`.`Admistrador_has_Report` (
  ...
  CONSTRAINT `fk_Admistrador_has_Report_Admistrador1`
    ...
    REFERENCES `worldgames`.`Admistrador` (`ID_Administrador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
