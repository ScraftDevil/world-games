...
CREATE TABLE IF NOT EXISTS `worldgames`.`Administrator` (
  ...
  `BirthDate` DATE NULL,
  `Shop_id` INT NOT NULL,
  PRIMARY KEY (`ID_Administrator`, `Shop_id`),
  INDEX `fk_Admistrador_Shop1_idx` (`Shop_id` ASC),
...
-- -----------------------------------------------------
-- Table `worldgames`.`Platform`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `worldgames`.`Platform` (
...
CREATE TABLE IF NOT EXISTS `worldgames`.`Game` (
  ...
  PRIMARY KEY (`ID_Game`, `Platform_ID`),
  INDEX `fk_Game_Plataform1_idx` (`Platform_ID` ASC),
  CONSTRAINT `fk_Game_Plataform1`
    FOREIGN KEY (`Platform_ID`)
    REFERENCES `worldgames`.`Platform` (`ID_Platform`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `worldgames`.`Offer` (
  ...
  PRIMARY KEY (`ID_Offer`, `Game_ID`),
  INDEX `fk_Offer_Game1_idx` (`Game_ID` ASC),
  CONSTRAINT `fk_Offer_Game1`
    FOREIGN KEY (`Game_ID`)
...
CREATE TABLE IF NOT EXISTS `worldgames`.`Game_has_Valoration` (
  ...
  `Registered_ID` INT NOT NULL,
  PRIMARY KEY (`Game_ID`, `Valoration_ID`, `Registered_ID`),
  INDEX `fk_Game_has_Valoration_Valoration1_idx` (`Valoration_ID` ASC),
  INDEX `fk_Game_has_Valoration_Game1_idx` (`Game_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `worldgames`.`Game_has_Complaint` (
  ...
  PRIMARY KEY (`Game_ID`, `Complaint_ID`),
