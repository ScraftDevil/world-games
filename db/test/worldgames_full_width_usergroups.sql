...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2016 a las 14:10:04
...
INSERT INTO `administrator` (`ID_Administrator`, `Username`, `Password`, `Email`, `BannedTime`, `BirthDate`, `Shop_id_Shop`, `ID_Group`) VALUES
(1, 'admin', 'admin', 'admin@admin.com', NULL, '2016-05-04', 1, 2);
...
INSERT INTO `professional` (`ID_Professional`, `Username`, `Password`, `Email`, `BannedTime`, `BirthDate`, `Telephone`, `Shop_ID`, `ID_Group`) VALUES
(1, 'professional', 'professional', 'professional@professional.com', NULL, '2016-05-01', NULL, 1, 3);
...
INSERT INTO `registered` (`ID_Registered`, `Username`, `Password`, `Email`, `BannedTime`, `BirthDate`, `PaypalAccount`, `AvatarURL`, `Shop_ID`, `Country_ID`, `ID_Group`) VALUES
(1, 'registered', 'registered', 'registered@registered.com', NULL, '1985-01-01', NULL, NULL, 1, 1, 1);
