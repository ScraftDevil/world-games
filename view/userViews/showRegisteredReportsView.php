            ...
            <section class="content-block gallery-1">
                <div class="container">
                    <div class="underlined-title">
                        ...
                        <hr>
                        <div class="editContent">
                            <h2>Aquí puedes visualizar todas tus quejas enviadas</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="grid col-xs-12 col-sm-8 col-md-8 col-lg-8 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
                        	...
                        	<?php
								...
								$registered = $shop->getRegisteredReports($id, $order);
